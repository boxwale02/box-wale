        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-between gap-8 text-center md:flex-row md:gap-12 lg:gap-16 md:text-left">
            ...
            <div className="flex-1 space-y-3 md:space-y-4">
              <h3 className="text-2xl font-bold text-white sm:text-2xl sm:text-3xl lg:text-2xl sm:text-3xl lg:text-4xl lg:text-2xl sm:text-3xl lg:text-4xl">
                Need Packaging Tailored to <br className="hidden sm:block" />
                Your Industry?
              </h3>
              <p className="text-sm sm:text-base text-amber-50/90 md:text-sm sm:text-sm sm:text-base lg:text-xl max-w-2xl">
            ...
            <CustomLink
              href="#"
              className="inline-flex shrink-0 items-center gap-2 rounded-full bg-white px-8 py-4 font-semibold text-amber-600 shadow-lg transition-all duration-300 hover:shadow-xl hover:bg-amber-50 md:px-10 md:py-5 lg:px-12 lg:py-6 lg:text-sm sm:text-sm sm:text-base"
              openModal={true}
              onClick={onModalOpen}
            >
