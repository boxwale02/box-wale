    ...
    <section className="relative overflow-hidden bg-white py-5 md:py-10">
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          ...
          <h2 className="mx-auto mt-6 max-w-3xl text-4xl font-bold tracking-tight text-gray-900 md:text-5xl">
            {data.heading}
          </h2>
        ...
        {/* <div className="mt-20 text-center">
          <h3 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl">
          ...
          <Link
            ...
            className="group inline-flex items-center gap-3 rounded-full bg-amber-600 px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-amber-600/25 transition-all duration-300 hover:bg-amber-700 hover:gap-4"
          >
